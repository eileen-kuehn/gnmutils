...
class Job(object):
    def __init__ (self, name=None, cmd=None, pid=None, ppid=None, uid=None,
            tme=None, exit_tme=None, error_code=None, signal=None, gpid=None,
            job_id=None, int_in_volume=None, int_out_volume=None,
            ext_in_volume=None, ext_out_volume=None, tree_depth=None,
            process_type=None, color=None, state=None):
        self.name = name
        self.cmd = cmd
        self.pid = int(pid)
        self.ppid = int(ppid)
    ...
    def getRow(self):
        return ("%s,%s,%d,%d,%d,%d,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s"
                %(stringutils.xstr(self.tme),
                    ...
                    stringutils.xstr(self.signal), self.int_in_volume,
