...
class TestObjectCacheFunctions(unittest.TestCase):
	...
	def test_insertRemove(self):
		...
		self.assertEqual(len(self.objectCache.objectCache), 1, "object cache should contain one process")
		...
		self.assertEqual(len(self.objectCache.objectCache), 2, "object cache should contain two different categories")
	...
	def test_clear(self):
		...
		self.assertEqual(len(self.objectCache.objectCache), 2, "object cache should contain two different categories")
		self.assertEqual(len(self.objectCache.faultyNodes), 0, "object cache should not have faulty nodes")
		self.assertEqual(len(self.objectCache.unfound), 0, "object cache should not have unfound nodes")
